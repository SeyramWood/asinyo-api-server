...
func (odq *OrderDetailQuery) sqlAll(ctx context.Context) ([]*OrderDetail, error) {
	...
	if odq.withOrder != nil || odq.withProduct != nil || odq.withStore != nil {
		withFKs = true
	}
	if withFKs {
		_spec.Node.Columns = append(_spec.Node.Columns, orderdetail.ForeignKeys...)
	}
	...
	if query := odq.withOrder; query != nil {
		...
		for i := range nodes {
			if nodes[i].order_details == nil {
				continue
			}
			fk := *nodes[i].order_details
		...
		for _, n := range neighbors {
			...
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "order_details" returned %v`, n.ID)
			}
			for i := range nodes {
	...
	if query := odq.withProduct; query != nil {
		ids := make([]int, 0, len(nodes))
		nodeids := make(map[int][]*OrderDetail)
		for i := range nodes {
	...
	if query := odq.withStore; query != nil {
		ids := make([]int, 0, len(nodes))
		nodeids := make(map[int][]*OrderDetail)
		for i := range nodes {
...
func (odgb *OrderDetailGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(odgb.fields) > 1 {
		return nil, errors.New("ent: OrderDetailGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := odgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (odgb *OrderDetailGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{orderdetail.Label}
	default:
		err = fmt.Errorf("ent: OrderDetailGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (odgb *OrderDetailGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(odgb.fields) > 1 {
		return nil, errors.New("ent: OrderDetailGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := odgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (odgb *OrderDetailGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{orderdetail.Label}
	default:
		err = fmt.Errorf("ent: OrderDetailGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (odgb *OrderDetailGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(odgb.fields) > 1 {
		return nil, errors.New("ent: OrderDetailGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := odgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (odgb *OrderDetailGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{orderdetail.Label}
	default:
		err = fmt.Errorf("ent: OrderDetailGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (odgb *OrderDetailGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(odgb.fields) > 1 {
		return nil, errors.New("ent: OrderDetailGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := odgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (odgb *OrderDetailGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{orderdetail.Label}
	default:
		err = fmt.Errorf("ent: OrderDetailGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ods *OrderDetailSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ods.fields) > 1 {
		return nil, errors.New("ent: OrderDetailSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ods.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ods *OrderDetailSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{orderdetail.Label}
	default:
		err = fmt.Errorf("ent: OrderDetailSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ods *OrderDetailSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ods.fields) > 1 {
		return nil, errors.New("ent: OrderDetailSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ods.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ods *OrderDetailSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{orderdetail.Label}
	default:
		err = fmt.Errorf("ent: OrderDetailSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ods *OrderDetailSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ods.fields) > 1 {
		return nil, errors.New("ent: OrderDetailSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ods.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ods *OrderDetailSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{orderdetail.Label}
	default:
		err = fmt.Errorf("ent: OrderDetailSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ods *OrderDetailSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ods.fields) > 1 {
		return nil, errors.New("ent: OrderDetailSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ods.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ods *OrderDetailSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{orderdetail.Label}
	default:
		err = fmt.Errorf("ent: OrderDetailSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
